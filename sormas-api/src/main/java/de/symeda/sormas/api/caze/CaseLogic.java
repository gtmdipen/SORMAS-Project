...
//			Method[] methods = HospitalizationDto.class.getMethods();
//			for (Method method : methods) {
//				if (method.getName().startsWith("set")
//					&& method.getParameterCount() == 1
//					&& method.getReturnType().equals(void.class)
//					&& !(method.getName().equals("setHospitalizedPreviously") || method.getName().equals("setPreviousHospitalizations"))) {
//					try {
//						method.invoke(caze.getHospitalization(), null);
